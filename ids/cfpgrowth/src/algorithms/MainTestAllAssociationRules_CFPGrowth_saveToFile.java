...
public class MainTestAllAssociationRules_CFPGrowth_saveToFile {
	...
	public static void main(String [] arg) throws IOException{
		...
		String transactions = fileToPath("/textfiles_real_medium_correct/database.txt");
		String frequentItemsetsComplete = ".//output_real_medium_correct_process.txt";
		String supportFile = fileToPath("/textfiles_real_medium_correct/support.txt");
		String MISfileComplete = fileToPath("/textfiles_real_medium_correct/mis.txt");
		//String closeOutputComplete = ".//close_output_swat_complete_sorted.txt";
		String invariants = ".//invariants_real_medium_correct_process.txt";
		String filteredInvariants = ".//filtered_invariants_real_medium_correct_process.txt";
